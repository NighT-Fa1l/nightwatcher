    ...
    async def on_message(self, message):
        ...
        if message.author.id == 831032738362425375:  # Replace with your actual user ID
            ...
            if user_id not in self.last_greeted or (now - self.last_greeted[user_id]).total_seconds() >= 3600:
                ...
                await message.reply('I been watching the server for you when you were away[.](https://cdn.discordapp.com/emojis/977619327811465276.webp?size=48&quality=lossless&name=CreepySmile)')
